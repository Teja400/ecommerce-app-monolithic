...
public class AddressController {
    ...
    public ResponseEntity<AddressDTO> getAddressesByAddressId(@PathVariable Long addressId) {
        AddressDTO addressDTO = addressService.getAddressesByAddressId(addressId);
